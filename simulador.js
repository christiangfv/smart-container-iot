...
const connectionString = 'HostName=Smart-Container-Hub.azure-devices.net;DeviceId=Container-001;SharedAccessKey=rB2EHMenBNe5GQsML/K49JynHBVK1WH6+qiGtE60NfA=';
const LEDPin = 4;
  ...
  sensor.readSensorData()
    .then(function (data) {
      cb(JSON.stringify({
        ...
        luminosity: data.temperature_C*0.33,
        open: 0,
        latitude: -33.5152938,
        longitude: -70.5949217,
